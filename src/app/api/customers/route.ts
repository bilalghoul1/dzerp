...
export async function GET(): Promise<NextResponse> {
  const guard = await apiGuardWithContext("crm.customer.view");
...
export async function POST(request: Request): Promise<NextResponse> {
  const guard = await apiGuardWithContext("crm.customer.create");
  if (guard.response) return guard.response;
...
export async function PATCH(request: Request): Promise<NextResponse> {
  const guard = await apiGuardWithContext("crm.customer.update");
  if (guard.response) return guard.response;
...
export async function DELETE(request: Request): Promise<NextResponse> {
  const guard = await apiGuardWithContext("crm.customer.delete");
  if (guard.response) return guard.response;
