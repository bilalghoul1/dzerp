...
export async function GET(): Promise<NextResponse> {
  const guard = await apiGuardWithContext("crm.supplier.view");
...
export async function POST(request: Request): Promise<NextResponse> {
  const guard = await apiGuardWithContext("crm.supplier.create");
  if (guard.response) return guard.response;
...
export async function PATCH(request: Request): Promise<NextResponse> {
  const guard = await apiGuardWithContext("crm.supplier.update");
  if (guard.response) return guard.response;
...
export async function DELETE(request: Request): Promise<NextResponse> {
  const guard = await apiGuardWithContext("crm.supplier.delete");
  if (guard.response) return guard.response;
