...
export async function GET(): Promise<NextResponse> {
  const guard = await apiGuardWithContext("product.view");
...
export async function POST(request: Request): Promise<NextResponse> {
  const guard = await apiGuardWithContext("product.create");
  if (guard.response) return guard.response;
...
export async function PATCH(request: Request): Promise<NextResponse> {
  const guard = await apiGuardWithContext("product.update");
  if (guard.response) return guard.response;
...
export async function DELETE(request: Request): Promise<NextResponse> {
  const guard = await apiGuardWithContext("product.delete");
  if (guard.response) return guard.response;
