...
export async function GET(): Promise<NextResponse> {
  const guard = await apiGuardWithContext("warehouse.view");
...
export async function POST(request: Request): Promise<NextResponse> {
  const guard = await apiGuardWithContext("warehouse.create");
  if (guard.response) return guard.response;
...
export async function PATCH(request: Request): Promise<NextResponse> {
  const guard = await apiGuardWithContext("warehouse.update");
  if (guard.response) return guard.response;
...
export async function DELETE(request: Request): Promise<NextResponse> {
  const guard = await apiGuardWithContext("warehouse.delete");
  if (guard.response) return guard.response;
