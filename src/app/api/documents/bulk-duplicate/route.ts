...
import { duplicateDocumentsBulk, getAllDocTypes } from "@/features/documents/engine";
...
export async function POST(request: Request): Promise<NextResponse> {
  ...
  return runScoped(guard.context, async () => {
    try {
      ...
      const result = await duplicateDocumentsBulk(docs, {
      ...
      console.error("documents/bulk-duplicate POST error:", error);
