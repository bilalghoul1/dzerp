...
const COPY: Record<Lang, {
  ...
  ar: {
    ...
    trialInfo: "تجربتك تبدأ فوراً ومدتها 14 يومًا. سيتولى المسؤول التحقق لاحقًا.",
  ...
  fr: {
    ...
    trialInfo: "Votre essai démarre immédiatement et dure 14 jours. Un administrateur vérifiera ultérieurement.",
  ...
  en: {
    ...
    trialInfo: "Your trial starts immediately and lasts 14 days. An admin will verify later.",
